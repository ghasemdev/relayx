---
name: speckit-code-modernization-harden
...
metadata:
  ...
  source: code-modernization:commands/modernize-harden.md
---
...
```
Workflow({
  scriptPath: "${CLAUDE_PLUGIN_ROOT:-.specify/extensions/code-modernization}/workflows/harden-scan.js",
  args: { system: "$1" }
})
```

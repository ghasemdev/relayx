---
name: speckit-code-modernization-preflight
...
metadata:
  ...
  source: code-modernization:commands/modernize-preflight.md
---
...
`build/`, `eng/`, `tools/`, or `.specify/extensions/code-modernization/scripts/` directory). These files are the

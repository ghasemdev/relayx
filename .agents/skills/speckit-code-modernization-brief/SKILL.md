---
name: speckit-code-modernization-brief
...
metadata:
  ...
  source: code-modernization:commands/modernize-brief.md
---
...
- Exit criteria (what .specify/extensions/code-modernization/tests/metrics prove it's done)

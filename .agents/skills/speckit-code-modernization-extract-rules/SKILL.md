---
name: speckit-code-modernization-extract-rules
...
metadata:
  ...
  source: code-modernization:commands/modernize-extract-rules.md
---
...
```
Workflow({
  scriptPath: "${CLAUDE_PLUGIN_ROOT:-.specify/extensions/code-modernization}/workflows/extract-rules.js",

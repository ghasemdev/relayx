---
name: speckit-code-modernization-status
...
metadata:
  ...
  source: code-modernization:commands/modernize-status.md
---
...
| reimagine | `modernized/$1-reimagined/` — note per-service acceptance tests and the `AGENTS.md` / `CLAUDE.md` handoff (reimagine's completion markers; it does NOT write `TRANSFORMATION_NOTES.md`) |

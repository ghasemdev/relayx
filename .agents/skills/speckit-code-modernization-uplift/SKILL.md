---
name: speckit-code-modernization-uplift
...
metadata:
  ...
  source: code-modernization:commands/modernize-uplift.md
---
...
```
Workflow({
  scriptPath: "${CLAUDE_PLUGIN_ROOT:-.specify/extensions/code-modernization}/workflows/uplift-deltas.js",
...
```
Workflow({
  scriptPath: "${CLAUDE_PLUGIN_ROOT:-.specify/extensions/code-modernization}/workflows/uplift-migrate.js",

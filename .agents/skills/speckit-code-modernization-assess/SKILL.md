---
name: speckit-code-modernization-assess
...
metadata:
  ...
  source: code-modernization:commands/modernize-assess.md
---
...
```
Workflow({
  scriptPath: "${CLAUDE_PLUGIN_ROOT:-.specify/extensions/code-modernization}/workflows/portfolio-assess.js",

---
name: speckit-code-modernization-reimagine
...
metadata:
  ...
  source: code-modernization:commands/modernize-reimagine.md
---
...
```
Workflow({
  scriptPath: "${CLAUDE_PLUGIN_ROOT:-.specify/extensions/code-modernization}/workflows/reimagine-scaffold.js",
...
Write `modernized/$1-reimagined/AGENTS.md` (and/or `CLAUDE.md`) — the persistent context file for
...
map. This file IS the context that future agents and engineers will
